...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			</a> <a class="nav-link" href="review.html"> <i
					class="fas fa-fw fa-table"></i> <span>Review</span>
			</a> <a class="nav-link" href="itnews.html"> <i
					class="fas fa-fw fa-table" style="color: white"></i> <span
					style="color: white">IT News</span style="color: white">
			</a> <a class="nav-link" href="class.html"> <i
