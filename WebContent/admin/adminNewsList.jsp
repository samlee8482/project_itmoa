...
<title>ITMOA ADMIN - ITNews</title>
						...
						<div class="col-xl-12 col-lg-7">
							...
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<!-- Area Chart -->
											<form
												action="${pageContext.request.contextPath}/adminMemberList.jsp }">
												<h6 class="m-0 font-weight-bold text-primary">회원구분</h6>
												<select name="sk">
													<option name="option_mb_2" value="1">뉴스UID</option>
													<option name="option_mb_2" value="2">뉴스제목</option>
													<option name="option_mb_2" value="3">내용검색</option>
												</select> <input type="text" name="option_mb_3" /> <input
													type="submit" value="검색" />
											</form>
											<h6 class="m-0 font-weight-bold text-primary">총 x건의 데이터가
												조회되었습니다.</h6>
									</div>
									<div class="card-body">
