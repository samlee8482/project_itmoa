...
<body>
	...
	<form id="join-content" action="joinOk.do" name="frm" method="post"
		onsubmit="return chkSubmit()">

		<div class="a" id="agreement">
			<div class="text_1">
			...
			<div class="chkbox">
				<input type="checkbox" required="required">개인정보 수집 및 이용에 대한 안내(필수)
			</div>
		</div>

		<div id="join-info"  class="a">
			<div id="info1">
				이름 <br>
			...
			<div id="info_addr">
				주소<br> <input type="text" id="sample6_postcode" name="mb_zip"
					placeholder="우편번호"
				...
				<input class="addr" type="text" id="sample6_address" name="mb_add1"
					...
					id="sample6_detailAddress" name="mb_add2" placeholder="상세주소">
